...
export default function DosenPublikasiPage() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.data?.success) {
        setIsFormOpen(false)
        fetchData()
        setFormData({ judul: "", jenis: "Publikasi", deskripsi: "", tahun: new Date().getFullYear(), file_url: "" })
      } else {
  ...
  const columns = [
    ...
    },
    {
      ...
      ) : <span className="text-xs text-neutral-400 italic">Tidak ada tautan</span>
    },
    {
      header: "Aksi",
      ...
      cell: (item: any) => (
        <div className="flex justify-end">
          <DropdownMenu>
            <DropdownMenuTrigger className="inline-flex items-center justify-center h-8 w-8 rounded-md hover:bg-neutral-100">
      ...
      <PageHeader 
        ...
        action={
          <FormDialog
            ...
            title={isEditMode ? "Edit Publikasi" : "Tambah Publikasi"}
            description="Masukkan informasi publikasi jurnal atau konferensi Anda."
            ...
            <div className="space-y-4 py-2">
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  placeholder="Cth: Implementasi IoT pada Smart Grid..." 
              ...
              <div className="space-y-2">
                <Label htmlFor="deskripsi" className="text-xs font-bold uppercase text-neutral-500">Deskripsi / Keterangan</Label>
                <Textarea 
                  id="deskripsi" 
                  value={formData.deskripsi}
                  onChange={(e) => setFormData({...formData, deskripsi: e.target.value})}
                  placeholder="Tuliskan deskripsi atau detail jurnal/konferensi..." 
