  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (resMe?.data?.success) {
        ...
        setUser(userData)
        const resTD = await apiGet(`/tri-dharma?dosen_id=${userData.id}&jenis=Buku Ajar`)
    ...
    },
    {
      ...
      cell: (item: any) => item.file_url ? (
        <a href={item.file_url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-xs font-bold text-primary hover:underline bg-primary/5 px-3 py-1.5 rounded-lg">
          Lihat Buku <ExternalLink size={12} />
        </a>
          ...
          <FormDialog
            ...
            trigger={
              <Button 
                onClick={() => {
                  setIsEditMode(false)
                  setFormData({ judul: "", jenis: "Buku Ajar", deskripsi: "", tahun: new Date().getFullYear(), file_url: "" })
                }}
            ...
            <div className="space-y-4 py-2">
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  placeholder="Cth: Dasar-Dasar Internet of Things..." 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="link" className="text-xs font-bold uppercase text-neutral-500">Link Buku (URL)</Label>
                  <Input 
                    id="link" 
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  placeholder="Tuliskan penerbit atau deskripsi singkat buku..." 
