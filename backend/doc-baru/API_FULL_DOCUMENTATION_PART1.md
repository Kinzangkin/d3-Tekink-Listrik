...
```
> **Catatan**: Mulai sekarang, token MURNI dikirim via SMTP Email. API tidak lagi memunculkan token ini di Response Body demi keamanan (God Mode).
...
**❌ Response 400:**
```json
{ "success": false, "message": "Token reset password tidak valid atau sudah kadaluarsa" }
```
