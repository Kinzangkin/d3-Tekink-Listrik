...
## 🏛️ H. PROFIL PRODI (Visi, Misi, Tujuan)

### `GET /api/v1/profil-prodi`
- **Akses**: Public
- **Query Param (Opsional)**: `?tipe=Visi` atau `?tipe=Misi` atau `?tipe=Tujuan`
...
```json
{
  ...
  "data": [
    { "id": 1, "tipe": "Visi", "deskripsi": "Menjadi prodi teknik unggulan di tahun 2030", "urutan": 1 }
  ]
}
```
...
**✅ Response 201 Created:**
```json
{ "success": true, "message": "Data berhasil ditambahkan", "data": { ... } }
```

---

### `PUT /api/v1/profil-prodi/{id}`
- **Akses**: Admin Only
- **Content-Type**: `application/json`
